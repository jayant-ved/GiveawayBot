...
# 1. Helper function to read list files
...
intents.message_content = True  # Tells your code to use the Message Content Intent
intents.members = True          # Tells your code to use the Server Members Intent
...
# 5. Run the bot
# Replace your hardcoded token with this:
